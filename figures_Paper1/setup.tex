...
\pgfplotsinvokeforeach{0,1,...,3} {
   \draw[color=horange] (axis cs:0,#1,0) -- (axis cs:1,#1,0);
   \draw[color=horange] (axis cs:0,#1,1) -- (axis cs:1,#1,1);
   \draw[color=horange] (axis cs:0,#1,2) -- (axis cs:1,#1,2);
   \draw[color=horange] (axis cs:0,#1,3) -- (axis cs:1,#1,3);
};
...
\pgfplotsinvokeforeach{0,1,...,3} {
   \draw[color=horange] (axis cs:3,#1,0) -- (axis cs:4,#1,0);
   \draw[color=horange] (axis cs:3,#1,1) -- (axis cs:4,#1,1);
   \draw[color=horange] (axis cs:3,#1,2) -- (axis cs:4,#1,2);
   \draw[color=horange] (axis cs:3,#1,3) -- (axis cs:4,#1,3);
};
...
\node at (axis cs:-0.1,3.5,-0.15) {\textcolor{hblue}{$\mu_r$}};
\node at (axis cs:5,3.5,-0.15) {\textcolor{hblue}{$\mu_l$}};
\node at (axis cs:2,2.8,-0.35) {\textcolor{hgreen}{$U,g$}};
\node at (axis cs:3.5,3,-0.25) {\textcolor{horange}{$\Gamma$}};
\node at (axis cs:1.3,3,-0.25) {\textcolor{black}{$v$}};
