...
plot './Green_hyb0.4phE4_O11.5.dat' u 1:(-1/3.1415)*($3) w l;
};


\addplot[dashed,raw gnuplot,color=hred,line width=1pt] gnuplot {
plot './neq_distr_f_filling_hyb0.4phE4_O11.5.dat' u 1:3 w l;
};
...
plot './Green_hyb0.8phE4_O11.5.dat' u 1:(-1/3.1415)*($3) w l;
};


\addplot[dashed,raw gnuplot,color=hlime,line width=1pt] gnuplot {
plot './neq_distr_f_filling_hyb0.8phE4_O11.5.dat' u 1:3 w l;
};
