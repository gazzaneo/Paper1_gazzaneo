...
%\usepackage{gnuplot-lua-tikz}                     % macOS does not like it -> restore if you need it
...
xlabel={$\omega$},
ylabel={$A(\omega)$},
legend style={at={(axis cs:-8.8,0.017)},anchor=north,mark options={scale=1.0},/tikz/every odd column/.append style={column sep=0.5mm},legend columns=1},
...
\addplot[name path=neq_distr_f_filling_hyb0.4O5,solid,raw gnuplot,color=hcoral,line width=1pt,opacity=0.0] gnuplot {
...
\addplot [fill=hcoral,fill opacity=0.5] fill between[of=neq_distr_f_filling_hyb0.4O5 and xaxis,soft clip={domain=-15:15}];
...
% \node[fill=none,color=hred,scale={1.0}] at (axis cs:1.20,0.022){$F$};
 ...
 \node[draw,fill=white,scale=1.0] at (axis cs:11.25,0.085) {$\Omega=5$};
...
xlabel={$\omega$},
% ylabel={$A(\omega)/t^{*-1}$},
legend style={at={(axis cs:-22.0,0.034)},anchor=west,mark options={scale=1.0},/tikz/every odd column/.append style={column sep=0.5mm},legend columns=1},
legend cell align=left,
clip mode=individual,
clip marker paths=true, 
xtick={-15,-10,-5,0,5,10,15},
...
\addplot[name path=neq_distr_f_filling_hyb0.8O11,solid,raw gnuplot,color=hlime,line width=1pt,opacity=0.0] gnuplot {
...
\addplot [fill=hlime,fill opacity=0.5] fill between[of=neq_distr_f_filling_hyb0.8O11 and xaxis,soft clip={domain=-15:15}];
     

% \node[fill=none,color=hblue,scale={1.0}] at (axis cs:-1.20,0.017){$F$};
% \node[fill=none,color=hred,scale={1.0}] at (axis cs:1.20,0.022){$F$};
 \node[fill=none,scale=1.0] at (axis cs:-13.5,0.085) {\bfseries(b)};
 \node[draw,fill=white,scale=1.0] at (axis cs:11.25,0.085) {$\Omega=11$};
