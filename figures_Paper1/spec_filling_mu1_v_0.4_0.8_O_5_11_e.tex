...
\addplot[name path=neq_distr_f_filling_hyb0.4O5,solid,raw gnuplot,color=hblue,line width=1pt,opacity=0.0] gnuplot {
...
\addplot[name path=neq_distr_f_filling_hyb0.8O5,solid,raw gnuplot,color=hred,line width=1pt,opacity=0.0] gnuplot {
...
\addplot [fill=hblue,fill opacity=0.5] fill between[of=neq_distr_f_filling_hyb0.4O5 and xaxis,soft clip={domain=-15:15}];
\addplot [fill=hred,fill opacity=0.5] fill between[of=neq_distr_f_filling_hyb0.8O5 and xaxis,soft clip={domain=-15:15}];
