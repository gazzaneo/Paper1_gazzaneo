...
\resub{One should comment on the validity of DMFT, which should be accurate for large dimensions only, for the present quasi 2-D setup. As a matter of fact, the hybridization to the leads introduces a dissipation that suppresses 2D-coherence and thus makes nonlocal correlations beyond DMFT less relevant.
